...
function bombs() {
	...
	setTimeout(hideExplosion, 9000, ska, count); //call hideExplosion function to disappear the bomb P.S bomb gets disappear after 8000ms i.e 9secs
...
function isOverlapping(div1, div2, c) {
	...
	const di1 = div1.getBoundingClientRect();
